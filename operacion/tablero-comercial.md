...
- 2026-06-07 13:10 ART: no aparecieron pedidos, trabajos ni leads verificables. Se agrego en `/empezar.html` una ruta rapida para visitantes que llegan desde GitHub o herramientas gratis, con CTA directo a Bundle, Base y Auditoria; JSON-LD y enlaces PayPal validados.
